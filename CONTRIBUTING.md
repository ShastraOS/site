...
- You want to start contributing open source repositories
- You have some of expertise in JavaScript, Next.js, CSS, etc.
- You have some knowledge of ShastraOS.
...
[CONTRIBUTING.md](https://github.com/Shastra-OS/site/CONTRIBUTING.md) core team
