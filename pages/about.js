                ...
                <div className={styles.duoGrid}>
                    ...
                    <div className={styles.aboutScroll}>
                        ...
                        <div className={styles.buttonGap}>
                            ...
                            <button className={styles.whiteBtn} onClick={() => { window.open('https://osdn.net/projects/shastraos/downloads/77103/Shastra-pre-2022.04.02-x86_64.iso/', "_blank") }}><MdDownload className={styles.icon}/>Download</button>
                        </div>
