                ...
                <div className={styles.duoGrid}>
                    ...
                    <div className={styles.aboutScroll}>
                        ...
                        <div className={styles.buttonGap}>
                            ...
                            <button className={styles.whiteBtn} onClick={() => { window.open('https://osdn.net/frs/redir.php?m=gigenet&f=shastraos%2F77132%2FShastra-Beta-2022.07.13-x86_64.iso', "_blank") }}><MdDownload className={styles.icon}/>Download</button>
                        </div>
