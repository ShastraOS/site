                ...
                <div className={styles.duoGrid}>
                    ...
                    <div className={styles.aboutScroll}>
                        ...
                        <div className={styles.buttonGap}>
                            <button className={styles.whiteBtn} onClick={() => { window.open('https://osdn.net/projects/shastraos/downloads/77132/ShastraDignity-Beta-2022.05.15-x86_64.iso/', "_blank") }}><MdDownload className={styles.icon}/>OSDN</button>
