                ...
                <div className={styles.duoGrid}>
                    ...
                    <div className={styles.aboutScroll}>
                        ...
                        <div className={styles.buttonGap}>
                            <button className={styles.whiteBtn} onClick={() => { window.open('https://osdn.net/frs/redir.php?m=nchc&f=shastraos%2F77132%2FShastraDignity-Beta-2022.05.07-x86_64.iso', "_blank") }}><MdDownload className={styles.icon}/>OSDN</button>
