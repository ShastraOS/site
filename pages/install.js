    ...
    return (
        <div className={'container'}>
            <Head>
                ...
                <meta name="keywords" content="ShastraOS, shastraos, shastra, shastra linux, vivek pal, akshat sharma, vivekpal, open source os, web3 os, decentralized os, blockchain on, blockchain, gnome os" />
            ...
            <main className={styles.main}>
                <div className={styles.duoGrid}>
                    ...
                    <div className={styles.aboutScroll}>
                        ...
                        <p>
                        While you can just download a hastraOS ISO image, can you be really sure that it&apos;s the right file?
                        With a few simple steps, you can verify the integrity of any ShastraOS ISO. Here&apos;s how to do it.
                        <br />
                        ...
                        <h4>Here are the checksums for iso file ShastraDignity-Beta-2022.05.07-x86_64.iso</h4>
                        <p>
                            File Size 2,912,759,808 bytes  <br/>
                            MD5 b4a7727c8a41fab6a83f05919e6d1492  <br />
                            SHA1 56819dbc2b51a9427deae635bd41b7e0aff987bf  <br />
                            SHA256 3acd6104b2d3eef60d90711fe81f93c354e94f87acce59260c69cffb207e8378
                        </p>
                        ...
                        You can also use Ventoy (On other device)</p>
                        ...
                        <p>
                            ...
                            We use Calamares as our default installer in the live environment.
                            Calamares is a user friendly and smooth installer. So that you can easily install your ShastraOS on a live environment and try out
                            ShastraOS before really installing it to your machine. <br />
                            ShastraOS installer does not require any internet connection by default, but we still prefer to have a good internet connection.
                            <br />
                        </p>
                        <p>Open Installer Application (you can search it by pressing Windows/Mod key.)</p>
                        <p>
                            Select your preferred location for timing and other settings.<br />
                            Now choose your default keyboard layout.
                        </p>
                        <h3>Partitioning scheme</h3>
                        <p>
                            Select your storage device, in which you want to install ShastraOS. <br />
                            If the target hard drive has an operating system already installed, Calamares is able to auto-detect it and give you the appropriate options.
                            <br />
                            <strong>You will get four options to install ShastraOS</strong>
                        </p>
                        <h4>Install alongside of previous OS</h4>
                        <p>Storage volume will be srinked for previous OS, and seprate volume partition will be created for ShastraOS on the same disk.</p>
                        <h4>Replace a partition</h4>
                        <p>A partition will replaced by ShastraOS and all your previous data will be erased. You will be able to choose a partition to replace.</p>
                        <h4>Erase entire disk and install ShastraOS</h4>
                        <p>This is the most recommended way to install ShastraOS in your machine. The disk you will choose will be erased and ShastraOS will installed on that particular disk.
                            <br />
                            You will be able to make a swap of 8gb or swap with hibernate.
                            If you want to learn about what is swap, go and check out this article. <a href='https://averagelinuxuser.com/linux-swap/'>What is Linux Swap?</a> <br />
                            Using swap is a very useful way to extend the RAM because it provides the necessary additional memory when the RAM space has been exhausted and a process has to be continued. It is especially recommended when you have less than 2Gb of RAM. Although in the end, everything depends on you.
                        </p>
                        <h4>Mannual Partitioning</h4>
                        <p>This is only recommended for andvanced users.</p>
                        <p>Select your own partitioning scheme. You must at least select an EFI(/boot/efi) partition and a root(/) partition.</p> <br />

                        <h4>User Data</h4>
                        <p>Username and passwords will be set here. You can set different passwords for normal use and for adminstrative tasks (root access). There&apos;s also an option to enable auto login at boot.</p>
                        <strong>Now you will see summary in the next step.</strong>
                        <p>Note that at this point no changes are physically done to the device. So don&apos;t be afraid if you made a mistake somewhere, you can go back and correct it.</p>
                        When you click &apos;Install&apos;, there&apos;s no going back. So do take a careful look at the summary and see if you&apos;ve missed anything. After hitting install, the installation process will begin. It will take around 10-15 minutes.
                        ...
                        Once you reboot, you&apos;ll be greeted by the lock screen.
                        Login and you are ready to use your ShastraOS <br />
